...
**OUTPUT:** You MUST save the result to a Markdown file in the `analysis/trial/` folder
...
3. Use the Write tool to save in `analysis/trial/`

**Filename format:** Base it on the input filename, replacing the extension with `_evaluation.md`

**Examples:**
- `sources/dtap_infanrix_package-insert.pdf` → `analysis/trial/dtap_infanrix_evaluation.md`
- `sources/mmr_clinical-trial-2015.pdf` → `analysis/trial/mmr_clinical-trial-2015_evaluation.md`
- `sources/hpv_gardasil_study.pdf` → `analysis/trial/hpv_gardasil_study_evaluation.md`
