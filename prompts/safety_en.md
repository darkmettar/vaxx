...
**OUTPUT:** You MUST save the result to a Markdown file in the `analysis/safety/` folder
...
2. If not mentioned, classify as ❓
3. When in doubt between two levels, choose the more conservative one
4. Be specific: cite numbers and durations when available
...
3. Use the Write tool to save in `analysis/safety/`

**Filename format:** Base it on the input filename, replacing the extension with `_safety.md`

**Examples:**
- `sources/dtap_infanrix_insert.pdf` → `analysis/safety/dtap_infanrix_safety.md`
- `sources/mmr_mmrii_clinical.pdf` → `analysis/safety/mmr_mmrii_safety.md`
- `sources/hpv_gardasil9_clinical.pdf` → `analysis/safety/hpv_gardasil9_safety.md`
